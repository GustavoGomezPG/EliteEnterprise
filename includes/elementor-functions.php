...
// Legacy Hello Elementor editor and frontend scripts removed
// Custom theme uses Vite-bundled assets loaded via script-imports.php or production-scripts.php
