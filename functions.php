...
// Load appropriate scripts based on environment
if (dist_folder_exists()) {
	// Production mode - load from dist
	require_once('includes/production-scripts.php');
} else {
	// Development mode - load individual files or Vite dev server
...
// Legacy Hello Elementor styles disabled - custom theme uses assets/css/main.css
// The style.css file only contains theme header metadata required by WordPress
